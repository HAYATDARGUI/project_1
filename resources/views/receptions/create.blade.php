            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="date" id="BR_Date" name="BR_Date" value="{{old('BR_Date')}}" @error('La date')
                            is-invalid @enderror autocomplete="La date" autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="BR_Qte" name="BR_Qte" value="{{old('BR_Qte')}}" @error('Qantite')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="BR_Transporte" name="BR_Transporte" value="{{old('BR_Transporte')}}"
                            @error('Transporte') is-invalid @enderror autocomplete="Transporte" autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="BR_Note" name="BR_Note" value="{{old('BR_Note')}}" @error('Note')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="BR_NoDocument" name="BR_NoDocument" value="{{old('BR_NoDocument')}}"
                            @error('No Document') is-invalid @enderror autocomplete="No Document" autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="dBR_BR" name="dBR_BR" value="{{old('dBR_BR')}}" @error('dBR_BR')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="dBR_SN" name="dBR_SN" value="{{old('dBR_SN')}}" @error('SN') is-invalid
                            @enderror autocomplete="SN" autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input type="radio" id="dBR_Garantie" name="dBR_Garantie" value="{{old('dBR_Garantie')}}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="dBR_Accessoires" name="dBR_Accessoires"
                            value="{{old('dBR_Accessoires')}}" @error('dBR_Accessoires') is-invalid @enderror
