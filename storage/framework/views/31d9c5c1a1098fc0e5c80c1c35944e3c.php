...
<form action="<?php echo e(route('receptions.update', $bonreception->id)); ?>" method="POST">
    <?php echo csrf_field(); ?>
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="date" id="BR_Date" name="BR_Date" value="<?php echo e($bonreception->BR_Date); ?>" <?php $__errorArgs = ['La
                            date'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="BR_Qte" name="BR_Qte" value="<?php echo e($bonreception->BR_Qte); ?>" <?php $__errorArgs = ['Qantite'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="BR_Transporte" name="BR_Transporte"
                            value="<?php echo e($bonreception->BR_Transporte); ?>" <?php $__errorArgs = ['Transporte'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="BR_Note" name="BR_Note" value="<?php echo e($bonreception->BR_Note); ?>" <?php $__errorArgs = ['Note'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="BR_NoDocument" name="BR_NoDocument"
                            value="<?php echo e($bonreception->BR_NoDocument); ?>" <?php $__errorArgs = ['No Document'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="dBR_BR" name="dBR_BR" value="<?php echo e($detail_br->dBR_BR); ?>" <?php $__errorArgs = ['dBR_BR'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="dBR_SN" name="dBR_SN" value="<?php echo e($detail_br->dBR_SN); ?>" <?php $__errorArgs = ['SN'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="radio" id="dBR_Garantie" name="dBR_Garantie" value="<?php echo e($detail_br->dBR_Garantie); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="dBR_Accessoires" name="dBR_Accessoires"
                            value="<?php echo e($detail_br->dBR_Accessoires); ?>" <?php $__errorArgs = ['dBR_Accessoires'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\laravelapp\resources\views/receptions/edition.blade.php ENDPATH**/ ?>