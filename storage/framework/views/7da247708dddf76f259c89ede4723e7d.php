...
<form method="POST" action="<?php echo e(route('produits.update',$produits->id)); ?>">

<?php echo csrf_field(); ?>
<?php echo method_field('PUT'); ?>
<label for="Produit_Nom"><?php echo e(__('Nom de produit:')); ?></label>
<input type="text" id="Produit_Nom" name="Produit_Nom" value="<?php echo e($produits->Produit_Nom); ?>" <?php $__errorArgs = ['Nom de produit'];
...
<input type="text" id="Produit_Ref" name="Produit_Ref" value="<?php echo e($produits->Produit_Ref); ?>" <?php $__errorArgs = ['Reference'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
<input type="text" id="Produit_Description" name="Produit_Description" value="<?php echo e($produits->Produit_Description); ?>" <?php $__errorArgs = ['Description de produit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
<input type="submit" value="<?php echo e(__('enregistrer')); ?>" class="button">

</form>


<?php echo $__env->make("master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\laravelapp\resources\views/produits/modifier.blade.php ENDPATH**/ ?>